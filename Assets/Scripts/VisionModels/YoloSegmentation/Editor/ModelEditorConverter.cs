...
namespace VisionModels.YoloSegmentation.Editor
{
    ...
    public class ModelConverterEditor : UnityEditor.Editor
    {
        ...
        public void OnEnable()
        {
            ...
            _classCount = serializedObject.FindProperty("classCount").intValue;
        }
        ...
        private void ConvertModel()
        {
            ...
            FunctionalTensor allScores = boxOutput[0, 4..(_classCount + 4), ..].Transpose(0, 1);
            FunctionalTensor allMasks = boxOutput[0, (_classCount + 4).., ..].Transpose(0, 1);
