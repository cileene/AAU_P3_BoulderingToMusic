...
namespace VisionModels.PoseDetection
{
    public static class BlazeUtils
    {
        ...
        private static ComputeShader s_ImageTransformShader = Resources.Load<ComputeShader>("ComputeShader/ImageTransform");
        private static int s_ImageSample = s_ImageTransformShader.FindKernel("ImageSample");
        private static int s_Optr = Shader.PropertyToID("Optr");
        private static int s_X_tex2D = Shader.PropertyToID("X_tex2D");
        private static int s_O_height = Shader.PropertyToID("O_height");
        private static int s_O_width = Shader.PropertyToID("O_width");
        private static int s_O_channels = Shader.PropertyToID("O_channels");
        private static int s_X_height = Shader.PropertyToID("X_height");
        private static int s_X_width = Shader.PropertyToID("X_width");
        private static int s_affineMatrix = Shader.PropertyToID("affineMatrix");
